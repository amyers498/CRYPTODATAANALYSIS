...
def calculate_profitability(investment, entry_price, take_profit_price, stop_loss_price):
    ...
    loss_stop_loss = investment - (investment / entry_price * stop_loss_price) + total_cost
...
def quick_trade_analysis(data, investment, effective_price):
    ...
    # Fee & Break-Even Info
    # Since we're calculating P/L at TP and SL, breakeven is not that relevant here
